...
const NAV_GROUPS: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Transportadoras', href: ROUTES.CARRIERS,      icon: Truck,       permission: 'carriers.view'  },
      { label: 'Vendedores',      href: ROUTES.SELLERS,       icon: UserCog,     permission: 'sellers.view'   },
      { label: 'Parceiros',       href: ROUTES.PARTNERS,      icon: Handshake,   permission: 'partners.view'  },
      { label: 'Centros de Custo',href: ROUTES.COST_CENTERS,  icon: Landmark,    permission: 'cost_centers.view' },
    ],
  },
  {
    label: 'Estoque',
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Auditoria',        href: ROUTES.AUDIT_LOGS,    icon: ScrollText, permission: 'users.view' },
    ],
  },
  {
    label: 'Configurações',
    icon:  Settings,
    items: [
      { label: 'Sistema',          href: ROUTES.SYSTEM_SETTINGS,    icon: SlidersHorizontal, permission: 'settings.view' },
