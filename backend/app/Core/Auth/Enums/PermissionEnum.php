...
enum PermissionEnum: string
{
    ...
    public function module(): string
    {
        return match ($this) {
            ...
            self::FinancialBankingData                                                     => 'accounts_payable',
            self::FinancialAccountsReceivable                                              => 'accounts_receivable',
    ...
    public function label(): string
    {
        return match ($this) {
            ...
            self::FinancialView               => 'Visualizar',
            self::FinancialCreate             => 'Registrar lançamentos',
            self::FinancialUpdate             => 'Editar lançamentos',
            self::FinancialDelete             => 'Excluir lançamentos',
            self::FinancialAccountsPayable    => 'Acesso ao módulo',
            self::FinancialAccountsReceivable => 'Acesso ao módulo',
